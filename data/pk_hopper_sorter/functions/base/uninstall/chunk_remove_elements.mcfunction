#> pk_hopper_sorter:base/uninstall/chunk_remove_elements
...
execute as @e[type=marker,tag=pk.ho_so.hopper_sorter.controller] at @s run function pk_hopper_sorter:blocks/hopper_sorter/remove/trigger
...
execute if score $uninstall.remaining_chunks pk.value matches 0 run schedule function pk_hopper_sorter:base/uninstall/stop 1t